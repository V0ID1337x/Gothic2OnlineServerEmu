...
public class BitStream : IDisposable {
  ...
  public void Write(SWIGTYPE_p_std__string inStringVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_3(swigCPtr, SWIGTYPE_p_std__string.getCPtr(inStringVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Write(string inStringVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_4(swigCPtr, inStringVar);
  }

  public void Write(SWIGTYPE_p_wchar_t inStringVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_5(swigCPtr, SWIGTYPE_p_wchar_t.getCPtr(inStringVar));
  }
  ...
  public void Write(float inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_16(swigCPtr, inTemplateVar);
  }

  public void Write(RakString inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_17(swigCPtr, RakString.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Write(RakNetGUID inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_18(swigCPtr, RakNetGUID.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Write(uint24_t inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_19(swigCPtr, uint24_t.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }
